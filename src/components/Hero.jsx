...
// import person from "../../public/assets/person-2.jpg"
        ...
        <section className="hero" id='hero'>
            <div className="hero_container flex">
                ...
                <div className="hero_container-text">
                    <h1>Hi, My name is Anthony, am a skilled tech freelancer with specialties in creating websites, designing webpages, and everything in between.</h1>
                    <p>I look forward to working with you. You are one click away.</p>
